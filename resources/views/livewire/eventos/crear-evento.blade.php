    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <x-adminlte-select name="fichaAsignacion" label="Ficha de formación" label-class="text-dark" fgroup-class="col-md-6" wire:model='fichaSeleccionada' wire:change='seleccionarPrograma'>
                        ...
                        <x-adminlte-input type="text" name="programaFormacion" label="Programa de Formación" fgroup-class="col-md-6" disabled value="{{ $programaFormacion->nombre }}" />
                        @endif
                    </div>
                    @if ($programaFormacion)
                    <div class="row">
                        <x-adminlte-select name="competenciaAsignacion" label="Competencia" label-class="text-dark" fgroup-class="col-md-6" wire:model='competenciaSeleccionada' wire:change='seleccionarResultados'>
