            ...
            <form wire:submit.prevent='editInstructor({{ $idinstructor }})' method="post">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="cedulaInstructor" name="cedulaInstructor" class="form-control"
                            wire:model="cedula">
                    </div>
                </div>
                <div class="row">
                    <div class=" form-group col-md-6">
                        <x-adminlte-select id="selectArea" name="selectArea" label="Área" label-class="text-dark"
                            wire:model="area">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="tipoInstructor" value="Virtual"
                                wire:model="tipo">
                            <label class="form-check-label">Virtual</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="tipoInstructor" value="Presencial"
                                wire:model="tipo">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="vinculacionInstructor" value="Planta"
                                wire:model="vinculacion">
                ...
                <div class="row">
                    <div class="form-group col-md-8">
                        ...
                        <input type="email" id="emailInstructor" name="emailInstructor" class="form-control"
                            wire:model="email">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="horasInstructor" class="text-dark">Horas Semanales</label>
                        <input type="number" id="horasInstructor" name="horasInstructor" class="form-control"
                            wire:model="horas">
                    </div>
                </div>
