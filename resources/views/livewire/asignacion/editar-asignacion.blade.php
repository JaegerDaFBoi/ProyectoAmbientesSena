<div>
    ...
    <div class="row">
        ...
        <x-adminlte-input type="text" name="programaFormacion" label="Programa de Formación" label-class="text-navy"
    ...
    <div class="row">
        ...
        <x-adminlte-textarea name="descripcionCompetencia" label="Descripción de competencia" label-class="text-navy"
            fgroup-class="col-md-6" rows=2 disabled>
